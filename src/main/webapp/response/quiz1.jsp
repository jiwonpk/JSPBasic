...
<body class="wrap-content">
	...
	<!-- 
		...
		1.class파일을 만들고 import를 해서 사용하는방법. (외부스타일시트)
		2.head태그에 선택자를 이용해서 디자인을 하는방법.	(내부스타일시트)
		3.태그자체에 직접디자인을 하는 방법. (인라인시트)
	 -->
	
	
	<form action="quiz01.jsp" method="post" id="form-content">
	
		<h3 style="text-align:center;color:blue;">zoom</h3>
		...
		수학:<input type="text"name="meth" class="form-control" ><br>
